...
class Surface {
  constructor() {
    ...
    this.surface.push(new box2d.b2Vec2(width / 4, height / 3 + 50));
	this.surface.push(new box2d.b2Vec2(width / 3, height / 2 + 50));
	this.surface.push(new box2d.b2Vec2(width / 2, height / 2 + 150));
